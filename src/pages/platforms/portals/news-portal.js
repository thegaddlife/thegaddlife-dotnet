...
import { NEWS_MONITOR_ID } from '@lib/constants';

export default function NewsPortalDetails() {
  return (
    <>
      {/* PAGE HEADING */}
      <PageHeader title="News" subtitle="Content Service">
        <p className="text-md lg:text-xl text-white max-w-2xl mb-8">This tool is used to create internal and external articles for Air1, K-LOVE and CRC websites.</p>
        <ButtonPrimary href="https://news.corpemf.com/" target="_blank" title="Visti News Portal">
      ...
      <section className="py-16 px-8 border-b border-zinc-800">
        ...
        <div className="max-w-7xl mx-auto">
          <ul className="ml-12 mt-4 list-disc text-white">
            <li>Users are required to be in AD Group: Application-News-Users</li>
          </ul>
        </div>
      </section>

      {/* UPTIME STATUS */}
      <Monitor monitorId={NEWS_MONITOR_ID}></Monitor>
    </>
  );
}
