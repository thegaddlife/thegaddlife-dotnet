...
import { BIBLE_MONITOR_ID } from '@lib/constants';

export default function NewsPortalDetails() {
  return (
    <>
      {/* PAGE HEADING */}
      <PageHeader title="Bible" subtitle="Content Service">
        <p className="text-md lg:text-xl text-white max-w-2xl mb-8">This portal is used to create and schedule Verse of the Day for K-LOVE and Air1.</p>
        <ButtonPrimary href="https://bible.corpemf.com/" target="_blank" title="Visit Bible Portal">
      ...
      <section className="py-16 px-8 border-b border-zinc-800">
        ...
        <div className="max-w-7xl mx-auto">
          <ul className="ml-12 mt-4 list-disc text-white">
            <li>Users are required to be in AD Group: Application-Bible-Users</li>
          </ul>
        </div>
      </section>

      {/* UPTIME STATUS */}
      <Monitor monitorId={BIBLE_MONITOR_ID}></Monitor>
    </>
  );
}
